...
<!-- ///////////////////////////////////////////////////////////////////////////////// -->
    ...
    <body onload="typeWriter()">
            ...
            <section id="wrapper">
                <div class="login-register">
                    <div class="row login-box" id="login-box-style">
                        ...
                        <div id="right-card-block-login" class="col-lg-6 b-l card-block">
                            <div class="form-group" >
                                <div class="input-group">
                                    ...
                                    <div class="dropdown-menu  dropdown-menu-right animated bounceInDown"> <a href="login-ar" id ="changeLang" class="dropdown-item" ><i class="flag-icon flag-icon-eg"></i> اللغة العربية</a></div>
                                </div>
                            </div>
                        ...
                        <div id="login-page-footer" class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                <div class="copyright_text">
                                    <p style="text-align: center;">
                                        Powered by <img src="assets/images/logo_02.png" /> Development Team @ Copyright &copy;
                                        <script>
        ...
        <script>
            var i = 0;
            var txt = "<?php echo htmlentities($loginMessage);?>";
            var speed = 50;
